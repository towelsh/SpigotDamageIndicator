...
public class DamageIndicatorCmd implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String s, String[] strings) {
        ...
        if (sender instanceof Player) {
            ...
            plr.sendMessage(ChatColor.AQUA+"This server is running "+ChatColor.GOLD+"DamageIndicator v1.1.1");
            ...
            logger.info(ChatColor.AQUA+"This server is running "+ChatColor.GOLD+"DamageIndicator v1.1.1");
            if (Bukkit.getPluginManager().getPlugin("PlaceholderAPI") != null) {
